<?php 
    ...
    $findDataFam_id = $famClass->Find('fam_id', 'std_id', $_SESSION['std_id']);
    $fam_id = $findDataFam_id->fetch(PDO::FETCH_ASSOC);

    $fam_id_index = $fam_id['fam_id'];
    $fam_id_array = array(0,0,0,0);
    
    for ($i = 0; $i < 4; $i++) {
        $findDataFam = $famClass->Find('*', 'fam_id', $fam_id_index);
        $dataFam = $findDataFam->fetch(PDO::FETCH_ASSOC);
        $fam_id_array[$i] = $dataFam['fam_id'];
        $fam_id_index++;
    }
    $findDataFam = array(null, null, null, null);
    $dataFam = array(null, null, null, null);

    for ($i = 0; $i < 2; $i++) 
        $findDataFam[$i] = $famClass->Find('fam_id, fam_firstname, fam_lastname, fam_tel, fam_career, fam_work_at, fam_status', 'fam_id', $fam_id_array[$i]);
    for ($i = 2; $i < 4; $i++) 
        $findDataFam[$i] = $famClass->Find('fam_id, fam_firstname, fam_lastname, fam_tel, fam_status, person_is', 'fam_id', $fam_id_array[$i]);
    for ($i = 0; $i < 4; $i++) 
        $dataFam[$i] = $findDataFam[$i]->fetch(PDO::FETCH_ASSOC);
...
<body>
                    ...
                    <form name="frm_data_self" id="form_student" action="" method="POST">
                        ...
                        <div class="grid sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 w-full mt-8 gap-x-4 gap-y-4 
                            ...
                            <div>
                                ...
                                <select name="select_sex_std" id="select_sex_std" disabled class="disable text-sm cursor-not-allowed bg-gray-100 w-52 h-8 pl-2 border border-gray-400">
                            ...
                            <div>
                                ...
                                <input type="text" name="txt_idcard" disabled value="<?php echo $dataStd['std_idcard']; ?>"
                                        class="disable cursor-not-allowed text-sm text-gray-600 border border-gray-400 bg-gray-100 outline-none h-8 pl-2 pr-2">
                            </div>
                            <div>
                                <p class="defocus ml-1 mb-1 text-md">รหัสนักศึกษา</p>
                                <input type="text" name="txt_idstd" disabled value="<?php echo $dataStd['std_id_student']; ?>"
                                        class="disable cursor-not-allowed text-sm text-gray-600 border border-gray-400 bg-gray-100 outline-none h-8 pl-2 pr-2">
                            </div>
                            <div>
                                <p class="defocus ml-1 mb-1 text-md">เบอร์โทรศัพท์</p>
                                <input type="text" name="txt_tel" disabled value="<?php echo $dataStd['std_tel']; ?>"
                                        class="disable cursor-not-allowed text-sm text-gray-600 border border-gray-400 bg-gray-100 outline-none h-8 pl-2 pr-2">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <select name="select_blood_type" id="select_blood_type" disabled class="disable text-sm cursor-not-allowed bg-gray-100 w-52 h-8 pl-2 border border-gray-400">
                            ...
                            <div>
                                ...
                                <select name="select_religion" id="select_religion" disabled class="disable text-sm cursor-not-allowed bg-gray-100 w-52 h-8 pl-2 border border-gray-400">
                            ...
                            <div>
                                ...
                                <select name="select_faculty" id="select_faculty" disabled class="disable text-sm cursor-not-allowed bg-gray-100 w-52 h-8 pl-2 border border-gray-400">
                            ...
                            <div>
                                ...
                                <select name="select_branch" id="select_branch" disabled class="disable text-sm cursor-not-allowed bg-gray-100 w-52 h-8 pl-2 border border-gray-400">
                    ...
                    <form name="frm_data_family" action="" method="POST">
                        ...
                        <div class="grid sm:grid-cols-2 mt-8 md:grid-cols-3 xl:grid-cols-4 w-full gap-x-4 gap-y-4 
                            ...
                            <div>
                                ...
                                <input type="text" name="txt_telParents1" disabled value="<?php echo $dataFam[0]['fam_tel']; ?>" 
                                        class="disable cursor-not-allowed text-sm text-gray-600 border border-gray-400 bg-gray-100 outline-none h-8 pl-2 pr-2">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <select name="select_statusParents1" id="select_statusParents1" disabled
                                        class="disable text-sm cursor-not-allowed bg-gray-100 w-52 h-8 pl-2 border border-gray-400">
                        ...
                        <div class="grid sm:grid-cols-2 mt-8 md:grid-cols-3 xl:grid-cols-4 w-full gap-x-4 gap-y-4 
                            ...
                            <div>
                                <p class="defocus ml-1 mb-1 text-md">เบอร์โทรศัพท์ที่ติดต่อได้</p>
                                <input type="text" name="txt_telParents2" disabled value="<?php echo $dataFam[1]['fam_tel']; ?>" 
                                        class="disable cursor-not-allowed text-sm text-gray-600 border border-gray-400 bg-gray-100 outline-none h-8 pl-2 pr-2">
                            </div>
                            <div>
                                <p class="defocus ml-1 mb-1 text-md">อาชีพ</p>
    ...
    <?php 
        ...
        if (isset($_POST['btn_hidden_edit_data1'])) {
            ...
            $valueStd[11] = $_POST['select_branch'];
