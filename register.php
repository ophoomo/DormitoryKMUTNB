...
<body>
    ...
    <?php
        ...
        if (isset($_POST['btn_register'])) {
            ...
            $std_salt = $endcodeClass->RandomSalt();
            ...
            $std_address = ( empty($_POST['txt_home_number']) ? "" : "บ้านเลขที่ ".$_POST['txt_home_number'])." ";
            $std_address = $std_address.( empty($_POST['txt_village_name']) ? "" : "หมู่บ้าน".$_POST['txt_village_name'])." ";
            $std_address = $std_address.( empty($_POST['txt_swine']) ? "" : "หมู่ที่ ".$_POST['txt_swine'])." ";
            $std_address = $std_address.( empty($_POST['txt_alley']) ? "" : "ซอย".$_POST['txt_alley'])." ";
            $std_address = $std_address.( empty($_POST['txt_road']) ? "" : "ถนน".$_POST['txt_road'])." ";
            $std_address = $std_address.( empty($_POST['txt_locality']) ? "" : "ตำบล".$_POST['txt_locality'])." ";
            $std_address = $std_address.( empty($_POST['txt_district']) ? "" : "อำเภอ".$_POST['txt_district'])." ";
            $std_address = $std_address.( empty($_POST['txt_province']) ? "" : "จังหวัด".$_POST['txt_province'])." ";
            $std_address = $std_address.( empty($_POST['txt_zipCode']) ? "" : "รหัสไปรษณีย์ ".$_POST['txt_zipCode'])." ";
            ...
            if($findUsername->rowCount() == 0) {
                // $endcodeClass->RandomSalt();
                $std_password = $endcodeClass->Encode($std_password);
            ...
            // Class Family zone
                $selectIdStd = $stdClass->Find('std_id' ,'std_idcard', $std_idcard);
        ...
        <form method="POST" action="" id="form_register" name="process_register">
            ...
            <div class="session userSelectNone">
                ...
                <div class="areaInput">
                    ...
                    <div class="question">
                        ...
                        <input  name="txt_idCard" type="text" maxlength="13" placeholder="เลขบัตรประจำตัวประชาชน">
                    </div>
                    ...
                    <div class="question">
                        <p>รหัสนักศึกษา</p>
                        <input name="txt_idStd" type="text" maxlength="13" placeholder="ถ้ายังไม่มีใส่เลขบัตรประชาชน">
                    </div>
            ...
            <div class="session userSelectNone">
                ...
                <div class="areaInput">
                    ...
                    <div  class="question">
                        <p>เบอร์โทรศัพท์</p>
                        <input name="txt_tel" type="text" placeholder="เบอร์โทรศัพท์">
                    </div>
                    ...
                    <div class="question">
                        ...
                        <input name="txt_village_name" type="text" placeholder="ชื่อหมู่บ้าน ตย.(รุ่งนิรันด์)">
                    </div>
                    ...
                    <div class="question">
                        <p>ซอย</p>
                        <input name="txt_alley" type="text" placeholder="ซอย ตย.(ยิ่งเจริญ)">
                    </div>
                    
                    <div class="question">
                        <p>ถนน</p>
                        <input name="txt_road" type="text" placeholder="ถนน ตย.(มิตรภาพ)">
                    </div>
            ...
            <div class="session userSelectNone">
                ...
                <div class="areaInput">
                    ...
                    <div class="question">
                        <p>ปีการศึกษาที่จบ</p>
                        <input  name="txt_stdEduComple" type="text" placeholder="ปี พ.ศ. 4 หลัก">
                    </div>
            ...
            <div class="session userSelectNone">
                ...
                <div class="areaInput">
                    ...
                    <div class="question">
                        ...
                        <input name="txt_telParents1" type="text" placeholder="เบอร์โทรศัพท์" id="telParents1">
                    </div>

                    <div class="question">
                        <p>อาชีพ</p>
                        <input name="txt_careerParents1" type="text" placeholder="โปรดระบุ เช่น พนักงานบริษัท">
                    </div>

                    <div class="question">
                        <p>สถานที่ทำงาน</p>
                        <input name="txt_workAtParents1" type="text" placeholder="ชื่อสถานที่ ตามด้วยจังหวัด">
                    </div>
                    
                    <div class="question">
                        <p>สถานะ</p>
                        <select name="select_statusParents1" id="blood_type">
            ...
            <div class="session userSelectNone">
                ...
                <div class="areaInput">
                    ...
                    <div class="question">
                        <p>เบอร์โทรศัพท์ที่ติดต่อได้</p>
                        <input name="txt_telParents2" type="text" placeholder="เบอร์โทรศัพท์" id="telParents2">
                    </div>

                    <div class="question">
                        <p>อาชีพ</p>
                        <input name="txt_careerParents2" type="text" placeholder="โปรดระบุ เช่น พนักงานบริษัท">
                    </div>

                    <div class="question">
                        <p>สถานที่ทำงาน</p>
                        <input name="txt_workAtParents2" type="text" placeholder="ชื่อสถานที่ ตามด้วยจังหวัด">
                    </div>
                    
                    <div class="question">
                        <p>สถานะ</p>
                        <select name="select_statusParents2" id="blood_type">
                            <option selected value="1">ยังมีชีวิตอยู่</option>
                            <option value="0">ถึงแก่กรรม</option>
                        </select>
                    </div>
