            ...
            <form name="frm_change_password" action="" method="POST">
                <div id="content" class="bg-white rounded-2xl pt-12 pb-10 shadow-md transition-all grid gap-y-4 justify-center">
                    ...
                    <div class="sm:grid grid-cols-4 sm:items-center">
                        ...
                        <input type="password" name="txt_password" class="sm:col-start-2 sm:col-span-4 sm:w-full shadow-sm text-md text-black border border-gray-400 bg-white outline-none h-8 pl-2 pr-2">
                    </div>
                    <div class="sm:grid grid-cols-4 sm:items-center">
                        <p class="sm:mr-4 sm:text-right defocus ml-1 mb-1 text-md">รหัสผ่านใหม่</p>
                        <input id="newPass" type="password" name="txt_newPassword" class="sm:col-start-2 sm:col-span-4 sm:w-full shadow-sm text-md text-black border border-gray-400 bg-white outline-none h-8 pl-2 pr-2">
                    </div>
                    <div class="sm:grid grid-cols-4 sm:items-center">
                        <p class="sm:mr-4 sm:text-right defocus ml-1 mb-1 text-md">ยืนยันรหัสผ่านใหม่</p>
                        <input id="newPass" type="password" name="txt_newPassword2" class="sm:col-start-2 sm:col-span-4 sm:w-full shadow-sm text-md text-black border border-gray-400 bg-white outline-none h-8 pl-2 pr-2">
                    </div>
                    ...
                    <div class="sm:grid grid-cols-4 sm:items-center">
                        <div class="sm:col-start-2 sm:col-span-3 text-center cursor-pointer mt-2 btnEdit text-red-900 p-1 pl-4 pr-4 round border-2 border-red-900 rounded-md 
                                                            hover:bg-red-900 hover:text-white" onclick="checkNewPasswordEqual()">
