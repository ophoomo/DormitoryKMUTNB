...
window.onload = () => {
    ...
    if (pathHash == '?dataStd') page = 0;
    else if (pathHash == '?dataFam') page = 1;
    else if (pathHash == '?dataSos') page = 2;
    else page = 0;
    changeShowData((page == 0 ? 'ข้อมูลนักศึกษา' : page == 1 ? 'ข้อมูลผู้ปกครอง' : 'ข้อมูลผู้ติดต่อฉุกเฉิน'), page);
}
