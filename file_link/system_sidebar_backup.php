...
<div id="sidebar"   class="overflow-y-scroll -ml-80 lg:ml-0 w-64 h-full fixed bg_red_nav 
                                transition-all duration-600 shadow-xl z-40 overflow-x-hidden">
        ...
        <div id="logo"          class="w-full flex flex-col items-center pb-3.5 line_b_white_5 transition-all duration-500">
            <img id="logo_img"  src="./assets/img/logoKmutnb.webp" alt="image" width="100"  class="mt-5 defocus">
            <p id="logo_text"   class="text-white tracking-widest font-light text-xl mt-4 transition-all
                                        font_kanit defocus">
                ระบบหอพักนักศึกษา
            </p>
        </div> <!-- End logo area -->
        ...
        <div id="list_menu" class="mt-4 flex flex-col ml-14 w-full transition-all pb-8 defocus">
            <ul class="list-item mt-4" style="list-style-type: circle;">
                ...
                <li class="menu mb-6 text-gray-300 hover:text-white duration-200">
                    <a href="fix_report.php">แจ้งซ่อม</a>
                </li>
                <li class="menu mb-6 text-gray-300 hover:text-white duration-200">
