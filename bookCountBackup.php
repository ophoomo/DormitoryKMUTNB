                    ...
                    <?php
                        ...
                        while ($value = $selectRoom->fetch(PDO::FETCH_ASSOC)):
                            if (($value['floor_id'] == $parameter['floor']) || 
                                ...
                                $unitPerson = $stdClass->Count('room_id', 'count', 'room_id', $value['room_id']);
                                $unitPerson = $unitPerson->fetch(PDO::FETCH_ASSOC);
                                echo "<script>console.log('".$unitPerson['count']."')</script>";
                    ?>
                                <div class="room w-full h-20 text-right rounded-lg cursor-pointer transition-all duration-400"
                                    ...
                                    <p class="defocus tracking-tighter mr-2 mt-2 text-sm font_kanit font-light">
                                        <span class="unitPerson"><?php echo $unitPerson['count'];?></span>
                                        <span class="">/</span>
                                    ...
                                    <div class="dorpdown-room font-medium absolute -ml-4 w-60 text-sm mt-5 pt-3 pb-1 shadow-2xl">
                                        <ul>
                                            <?php 
